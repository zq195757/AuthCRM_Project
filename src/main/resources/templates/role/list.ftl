                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <#list (pageResult.data)! as entity>
                            <tr>
                                ...
                                <td>${entity.sn}</td>
                                <td>
                                    <a class="btn btn-info btn-xs btn-input" href="/role/input?id=${entity.id}&currentPage=${pageResult.currentPage}">
                                        <span class="glyphicon glyphicon-pencil"></span> 编辑
                                    </a>
                                    <a href="#"
                                       curpage="${pageResult.currentPage}" onclick="deleteCurRole(this)" url_prefix="/role/delete?id=${entity.id}"
...
<script type="application/javascript">
    // 渲染DOM前就要声明好该函数
    function deleteCurRole(pointer){
